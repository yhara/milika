...
module {
  ...
  func.func private @chiika_env_push(!llvm.ptr, i64, i64) -> i64
  ...
  func.func @countdown(%arg0: !llvm.ptr, %arg1: i64, %arg2: (!llvm.ptr, i64) -> !llvm.ptr) -> !llvm.ptr {
    %f = constant @chiika_env_push : (!llvm.ptr, i64, i64) -> i64
    %0 = builtin.unrealized_conversion_cast %arg2 : (!llvm.ptr, i64) -> !llvm.ptr to !llvm.ptr
    %1 = llvm.ptrtoint %0 : !llvm.ptr to i64
    %c6_i64 = arith.constant 6 : i64
    %2 = call_indirect %f(%arg0, %1, %c6_i64) : (!llvm.ptr, i64, i64) -> i64
    %f_0 = constant @chiika_env_push : (!llvm.ptr, i64, i64) -> i64
    %c1_i64 = arith.constant 1 : i64
    %3 = call_indirect %f_0(%arg0, %arg1, %c1_i64) : (!llvm.ptr, i64, i64) -> i64
    %f_1 = constant @print : (i64) -> i64
    %4 = call_indirect %f_1(%arg1) : (i64) -> i64
    %f_2 = constant @sleep_sec : (!llvm.ptr, i64, (!llvm.ptr, i64) -> !llvm.ptr) -> !llvm.ptr
    %c0_i64 = arith.constant 0 : i64
    %f_3 = constant @countdown_1 : (!llvm.ptr, i64) -> !llvm.ptr
    %5 = call_indirect %f_2(%arg0, %c0_i64, %f_3) : (!llvm.ptr, i64, (!llvm.ptr, i64) -> !llvm.ptr) -> !llvm.ptr
    return %5 : !llvm.ptr
  }
  func.func @countdown_1(%arg0: !llvm.ptr, %arg1: i64) -> !llvm.ptr {
    %f = constant @chiika_env_ref : (!llvm.ptr, i64, i64) -> i64
    %c0_i64 = arith.constant 0 : i64
    %c1_i64 = arith.constant 1 : i64
    %0 = call_indirect %f(%arg0, %c0_i64, %c1_i64) : (!llvm.ptr, i64, i64) -> i64
    %c0_i64_0 = arith.constant 0 : i64
    %1 = arith.cmpi eq, %0, %c0_i64_0 : i64
    cf.cond_br %1, ^bb1, ^bb2
  ^bb1:  // pred: ^bb0
    %f_1 = constant @"countdown_1't" : (!llvm.ptr) -> !llvm.ptr
    %2 = call_indirect %f_1(%arg0) : (!llvm.ptr) -> !llvm.ptr
    return %2 : !llvm.ptr
  ^bb2:  // pred: ^bb0
    %f_2 = constant @"countdown_1'f" : (!llvm.ptr) -> !llvm.ptr
    %3 = call_indirect %f_2(%arg0) : (!llvm.ptr) -> !llvm.ptr
    return %3 : !llvm.ptr
  }
  func.func @"countdown_1't"(%arg0: !llvm.ptr) -> !llvm.ptr {
    ...
    %4 = call_indirect %2(%arg0, %3) : (!llvm.ptr, i64) -> !llvm.ptr
    return %4 : !llvm.ptr
  }
  func.func @"countdown_1'f"(%arg0: !llvm.ptr) -> !llvm.ptr {
    %f = constant @"countdown_1'e" : (!llvm.ptr, i64) -> !llvm.ptr
    %c0_i64 = arith.constant 0 : i64
    %0 = call_indirect %f(%arg0, %c0_i64) : (!llvm.ptr, i64) -> !llvm.ptr
    return %0 : !llvm.ptr
  }
  func.func @"countdown_1'e"(%arg0: !llvm.ptr, %arg1: i64) -> !llvm.ptr {
    %f = constant @countdown : (!llvm.ptr, i64, (!llvm.ptr, i64) -> !llvm.ptr) -> !llvm.ptr
    %f_0 = constant @chiika_env_ref : (!llvm.ptr, i64, i64) -> i64
    %c0_i64 = arith.constant 0 : i64
    %c1_i64 = arith.constant 1 : i64
    %0 = call_indirect %f_0(%arg0, %c0_i64, %c1_i64) : (!llvm.ptr, i64, i64) -> i64
    %c1_i64_1 = arith.constant 1 : i64
    %1 = arith.subi %0, %c1_i64_1 : i64
    %f_2 = constant @chiika_env_pop : (!llvm.ptr, i64) -> i64
    %c2_i64 = arith.constant 2 : i64
